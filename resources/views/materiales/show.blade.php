                    ...
                    <div class="mt-4">
                        <div>
                            <label class="block" for="name">
                                ...
                                value="{{$material->nombre}}" disabled>  
                            </label>        
                        </div>
                        ...
                        <div class="mt-4">
                            <label for="unidad">
                                ...
                                class="w-full px-4 py-2 mt-2 border-gray-400 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                                value="{{$material->unidad}}" disabled>
                            </label>
                        </div>
                        ...
                        <div class="mt-4">
                            <label for="nombre_unidad">
                                ...
                                class="w-full px-4 py-2 mt-2 border-gray-400 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                                value="{{$material->nombre_unidad}}" disabled>
                            </label>
                        </div>
                        ...
                        <div class="mt-4">
                            <label for="descripcion">
                                ...
                                class="w-full px-4 py-2 mt-2 border-gray-400 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                                value="{{$material->descripcion}}" disabled>
                            </label>
                        </div>
                        ...
                        <div class="mt-4">
                            <label for="lugar_compra">
                                ...
                                class="w-full px-4 py-2 mt-2 border border-gray-400 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                                value="{{$material->lugar_compra}}" disabled>
                            </label>
                        </div>

                        <div class="mt-4 flex items-center justify-center space-x-20">
                            <button type="button" onclick=" window.location.href='{{route('materiales.edit',$material)}}'"
