                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-4">
                            <label for="precio_compra">
                                ...
                                class="w-full px-4 py-2 mt-2 border-gray-400 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                                value="{{number_format($material->precio_compra,2,'.','')}}">
                            </label>
                        </div>
                        ...
                        <div class="mt-4">
                            <label for="precio_venta">
                                ...
                                value="{{number_format($material->precio_venta,2,'.',' ')}}">
                            </label>
                        </div>
                        ...
                        <div class="mt-4 flex items-center justify-center space-x-20">
                            ...
                            >Guardar</button>                            
                             ...
                             <a href="{{route('materiales.show',$material)}}" class="flex w-1/3 px-6 py-2 mt-4 text-white  bg-red-600 rounded-lg hover:bg-red-900" href="https://www.google.com">
                                <button type="button"                                    
